      ...
      <v-row justify="center" align="center">
        <v-col cols="12" sm="8" md="5" lg="4">
          <v-card elevation="12" class="pa-8 pb-10 rounded-xl login-card">
            ...
            <div class="text-center mb-10 form-header">
              ...
              <p class="text-subtitle-1 text-grey-darken-2">{{ t('auth.loginSubtitle') }}</p>
            </div>
            ...
            <v-form @submit.prevent="handleLogin" ref="form">
              ...
              <v-text-field
                ...
                base-color="grey-darken-1"
                class="mb-2"
                :rules="[v => !!v || t('auth.passwordRequired', 'Password is required')]"
                required
              ></v-text-field>
            ...
            <div class="text-center mt-8">
              <span class="text-body-2 text-grey-darken-1 font-weight-medium">{{ t('auth.noAccount') }}</span>
              <v-btn variant="text" color="secondary" class="font-weight-bold ml-2" to="/register">

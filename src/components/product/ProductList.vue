...
/**
 * Componente que exibe a listagem de Produtos.
 * Inclui funcionalidades para carregar, exibir, adicionar, editar e excluir registros.
 */
...
/**
 * Busca a lista de produtos no back-end e atualiza o estado da tabela.
 */
